                  ...
                  <PopMenuItem>
                    <div class="flex">
                      <svg class="mt-0.5 mr-2" width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path d="M11.52 2.49639H8.64V1.46923C8.64 0.995159 8.24 0.600098 7.76 0.600098H4.4C3.92 0.600098 3.52 0.995159 3.52 1.46923V2.49639H0.56C0.24 2.49639 0 2.73343 0 3.04948C0 3.36553 0.24 3.60257 0.56 3.60257H1.04L1.84 12.847C1.84 13.1631 2.08 13.4001 2.4 13.4001H9.6C9.92 13.4001 10.16 13.1631 10.16 12.847L10.96 3.60257H11.44C11.76 3.60257 12 3.36553 12 3.04948C12 2.73343 11.84 2.49639 11.52 2.49639ZM4.64 1.78528H7.44V2.49639H4.64V1.78528ZM9.12 12.2149H2.96L2.16 3.60257H9.76L9.12 12.2149Z" fill="#7E7E80"/>
                        <path d="M6.64 4.94578H5.44V10.9507H6.64V4.94578Z" fill="#7E7E80"/>
                        <path d="M4.88358 10.9515L4.66105 4.95076L3.46189 4.99413L3.68442 10.9949L4.88358 10.9515Z" fill="#7E7E80"/>
                      </svg>
                      Удалить
                    </div>
                  </PopMenuItem>
