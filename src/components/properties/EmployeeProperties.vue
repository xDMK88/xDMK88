<template>
  <div>
    ...
    <div class="mt-[20px] flex gap-[4px]">
      <div class="grow flex items-center gap-[4px] pl-[5px] pr-[9px] h-[30px] cursor-pointer bg-[#f4f5f7] rounded-[6px] font-roboto text-[#575758] text-[12px] font-medium">
        <svg
          width="20"
          height="20"
          viewBox="0 0 30 30"
...
export default {
  ...
  computed: {
    ...
    selectedEmployeeName () {
      return this.$store.state.employees.selectedEmployee?.name || ''
    },
    user () {
  ...
  methods: {
    removeEmployee (employee) {
      ...
      this.$store.dispatch(EMPLOYEE.REMOVE_EMPLOYEE_REQUEST, employee)
        .then(() => {
