...
<template>
  <div class="relative">
    <svg
      class="absolute top-4 z-10 left-[11px]"
      width="18"
      height="18"
      viewBox="0 0 18 18"
      fill="none"
