...
const typeofTasks = ['Непрочитанные задачи', 'В работе', 'В фокусе', 'Просрочено']
...
<template>
  ...
  <div class="flex justify-between flex-wrap">
    <div class="flex flex-col w-4/12 bg-white rounded-xl h-1/3 mb-14 overflow-auto max-h-[500px] max-w-screen-sm scroll-style" v-for="(elem, key, idx) in testObj" :key="testObj[key]">
      <tasksblock>
