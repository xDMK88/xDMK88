'use strict';var helpers=require('./helpers-1afc4b71.js'),vue=require('vue'),core=require('@popperjs/core'),CustomTransition=require('./CustomTransition.js'),styleInject_es=require('./style-inject.es-06def3b0.js');var script = {
  name: 'Popover',
  ...
  computed: {
    ...
    popperOptions: function popperOptions() {
      return {
        ...
        }].concat(helpers.F(this.modifiers || [])),
  ...
  methods: {
    addEvents: function addEvents() {
      helpers.o(this.popoverEl, 'click', this.onClick);
      helpers.o(this.popoverEl, 'mouseover', this.onMouseOver);
      helpers.o(this.popoverEl, 'mouseleave', this.onMouseLeave);
      helpers.o(this.popoverEl, 'focusin', this.onFocusIn);
      helpers.o(this.popoverEl, 'focusout', this.onFocusOut);
      helpers.o(document, 'keydown', this.onDocumentKeydown);
      helpers.o(document, 'click', this.onDocumentClick);
      helpers.o(document, 'show-popover', this.onDocumentShowPopover);
      helpers.o(document, 'hide-popover', this.onDocumentHidePopover);
      helpers.o(document, 'toggle-popover', this.onDocumentTogglePopover);
      helpers.o(document, 'update-popover', this.onDocumentUpdatePopover);
    },
    removeEvents: function removeEvents() {
      helpers.p(this.popoverEl, 'click', this.onClick);
      helpers.p(this.popoverEl, 'mouseover', this.onMouseOver);
      helpers.p(this.popoverEl, 'mouseleave', this.onMouseLeave);
      helpers.p(this.popoverEl, 'focusin', this.onFocusIn);
      helpers.p(this.popoverEl, 'focusout', this.onFocusOut);
      helpers.p(document, 'keydown', this.onDocumentKeydown);
      helpers.p(document, 'click', this.onDocumentClick);
      helpers.p(document, 'show-popover', this.onDocumentShowPopover);
      helpers.p(document, 'hide-popover', this.onDocumentHidePopover);
      helpers.p(document, 'toggle-popover', this.onDocumentTogglePopover);
      helpers.p(document, 'update-popover', this.onDocumentUpdatePopover);
    },
    ...
    onFocusOut: function onFocusOut(e) {
      if (!e.relatedTarget || !helpers.G(this.popoverEl, e.relatedTarget)) {
    ...
    onDocumentClick: function onDocumentClick(e) {
      ...
      if (helpers.G(this.popoverEl, e.target) || helpers.G(this.ref, e.target)) {
        return;
      } // Hide the popover
    ...
    show: function show() {
      ...
      var fn = function fn() {
        Object.assign(_this3, helpers.D(opts, ['id']));
    ...
    update: function update() {
      var opts = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};
      Object.assign(this, helpers.D(opts, ['id']));
      this.setupPopper();
    },
