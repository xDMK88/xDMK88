  ...
  <form class=" mx-12 overscroll-auto">
    <div class="flex pb-6">
      ...
      <form class="text-right w-1/4">
        <button
          class="bg-[#FF9123] hover:bg-[#EB7500]  rounded-xl text-white py-1 mt-4 px-2"
          type="button"
          @click="tarif()"
        >
          Управление тарифом
    ...
    <div class="text-left mt-6 mb-3 flex flex-wrap">
      ...
      <div class="mt-[60px]">
        ...
        <label
          for="iconfile"
          class="bg-gray-100 hover:bg-gray-200 rounded-xl ml-2 px-3 p-1"
        >Выберите фото</label>
        <br>
      </div>
    </div>
    ...
    <form>
      <button
        ...
        class="bg-gray-100 rounded-xl mt-4 px-3 p-1 hover:bg-gray-200"
      >
        Изменить имя
      </button>
    </form>
    ...
    <form>
      <button
        class="bg-gray-100 mt-2 rounded-xl px-3 p-1 hover:bg-gray-200"
        @click="pass()"
      >
        Изменить пароль
      </button>
    ...
    <form class="text-center">
      <button
        class="bg-gray-100 rounded-xl px-10 p-1 hover:bg-gray-200"
        @click="logout()"
      >
        Выйти из аккаунта
      </button>
