    ...
    <div class="flex justify-start">
      <div class="max-h-[100%] flex">
        ...
        >
          ...
          <div class="mt-3">
            <div class="flex justify-between">
              <p class="text-gray-400 text-sm width-[80]">
          ...
          <div class="mt-4">
            <button
              class="justify-between text-center h-full rounded-[6px] w-full p-2 bg-gray-50"
            >
              Добавить карточку
              <svg
                class="relative top-2 right-12 float-right"
                width="11"
                height="11"
                viewBox="0 0 11 11"
                fill="none"
