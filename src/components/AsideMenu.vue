...
<template>
  ...
  >
    ...
    <button type="submit" class="bg-[#403D38] rounded-xl px-10 p-3 text-white mt-4">
      Изменить
    </button>
</form>
<fieldset class="flex">
...
<form class="mx-12 mt-3 basis-1/10">
  <svg width="28" height="31" viewBox="0 0 28 31" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M2 0C0.895431 0 0 0.895431 0 2V3.92076C0 7.58112 2.17694 10.868 5.59249 12.2873C5.78016 14.4536 6.79357 16.4332 8.44504 17.8899C9.30831 18.6369 9.87132 19.6454 10.0965 20.7286H7.43164V24.4263H5.59249V29.0204H3.71582V31H24.2467V29.0204H22.4075V24.4263H20.5684V20.7286H17.9035C18.1287 19.6454 18.7292 18.6369 19.555 17.8899C21.2064 16.4706 22.2198 14.4536 22.4075 12.2873C25.7855 10.868 28 7.58112 28 3.92076V2C28 0.895431 27.1046 0 26 0H2ZM25.9357 1.97959V3.92076C25.9357 6.4606 24.5845 8.77634 22.37 10.0463V1.97959H25.9357ZM9.42091 24.4263V22.7455H18.5416V24.4263H9.42091ZM18.2038 16.3959C16.9276 17.5164 16.0643 19.0478 15.8391 20.7286H12.1609C11.9357 19.0478 11.0724 17.5164 9.79625 16.3959C8.40751 15.2007 7.6193 13.4452 7.6193 11.615V1.97959H20.4182V11.5776C20.3807 13.4452 19.555 15.2007 18.2038 16.3959ZM7.54424 29.0204V26.4059H20.3432V29.0204H7.54424ZM5.55496 10.0836C3.37802 8.81369 1.98928 6.4606 1.98928 3.92076V1.97959H5.55496V10.0836Z" fill="#FF9123"/>
  </svg>
</form>
</fieldset>
